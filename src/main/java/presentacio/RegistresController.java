...
/**
 * Controlador de la vista 'registres.fxml'. Permet a l'usuari visualitzar, cercar,
 * ordenar i exportar els registres d'un arxiu XML llistats dins una taula.
 *
...
public class RegistresController implements Initializable {
    ...
    /**
     * Mètode que retorna la columna que està seleccionada en un TableView.
     * Es crida dins el mètode d'ordenació: ordenarRegistresTableView() per canviar
    ...
    /**
     * Mètode que enllaça les columnes d'un TableView amb un
     * desplegable (ComboBox) per ordenar els registres d'un llistat.
     *
     * @author Txell Llanas - Creació/Implementació
     */
